...
class Number4: BaseScene {
    ...
    var tapIndex = 0
    let soundSequence = ["E1.mp4", "E2.mp4", "E3.mp4", "E4.mp4"]
    ...
    override func didMove(to view: SKView) {
        ...
        if let endLabel = EndLabel {
            let fullText = "Yes, it's number Four"
            ...
            let boldRange = (fullText as NSString).range(of: "Four")
    ...
    func checkCompletion() {
        if isBalloon1Popped && isBalloon2Popped && isBalloon3Popped && isBalloon4Popped {
            ...
            let Sound4 = SKAction.playSoundFileNamed("yes4.wav", waitForCompletion: false)
