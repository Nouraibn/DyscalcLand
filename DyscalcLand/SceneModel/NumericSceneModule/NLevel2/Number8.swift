...
class Number8: BaseScene {
    ...
    var tapIndex = 0
    let soundSequence = ["E1.mp4", "E2.mp4", "E3.mp4", "E4.mp4", "E5.mp4", "E6.mp4", "E7.mp4", "E8.mp4"]
    ...
    override func didMove(to view: SKView) {
        ...
        num8Balloon = self.childNode(withName: "ABalloon8") as? SKSpriteNode
        ...
        NumBalloon = self.childNode(withName: "Num8Balloon") as? SKSpriteNode
        ...
        if let endLabel = EndLabel {
            let fullText = "Yes, it's number Eight"
            ...
            let boldRange = (fullText as NSString).range(of: "Eight")
    ...
    func checkCompletion() {
        if isBalloon1Popped && isBalloon2Popped && isBalloon3Popped && isBalloon4Popped && isBalloon5Popped && isBalloon6Popped && isBalloon7Popped && isBalloon8Popped {
            ...
            let Sound4 = SKAction.playSoundFileNamed("yes8.wav", waitForCompletion: false)
    ...
    func navigateToNumber9() {
        ...
        if let number2Scene = SKScene(fileNamed: "Number9") as? BaseScene{
