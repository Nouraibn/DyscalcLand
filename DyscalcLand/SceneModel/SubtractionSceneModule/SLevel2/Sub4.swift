...
class Sub4: SKScene {
    ...
    var bowling8: SKSpriteNode!
    var bowling9: SKSpriteNode!
    ...
    var Bowling3Drop: SKSpriteNode!
    var Bowling4Drop: SKSpriteNode!
    ...
    override func didMove(to view: SKView) {
        ...
        bowling8 = self.childNode(withName: "Bowling8") as? SKSpriteNode
        bowling9 = self.childNode(withName: "Bowling9") as? SKSpriteNode
        ...
        Bowling3Drop = self.childNode(withName: "Bowling3Drop") as? SKSpriteNode
        Bowling4Drop = self.childNode(withName: "Bowling4Drop") as? SKSpriteNode
        ...
        Bowling3Drop?.isHidden = true
        Bowling4Drop?.isHidden = true
    ...
    func dropBowlingPins() {
        ...
        bowling7?.isHidden = true
        Bowling3Drop?.isHidden = false
        
        bowling9?.isHidden = true
        Bowling4Drop?.isHidden = false
